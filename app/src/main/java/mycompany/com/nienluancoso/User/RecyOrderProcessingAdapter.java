...
// */
//public class RecyOrderProcessingAdapter extends RecyclerView.Adapter<RecyOrderProcessingAdapter.ViewHolder> {
//    private Context mContext;
//    private List<OrderItemObject> orderObjectList;
//    private onClickListener onClickListener;
//
//    public RecyOrderProcessingAdapter(Context mContext, List<OrderItemObject> orderObjectList) {
//        this.mContext = mContext;
//        this.orderObjectList = orderObjectList;
//    }
//
//    public void setOnItemClickListener(RecyOrderProcessingAdapter.onClickListener onClickListener) {
